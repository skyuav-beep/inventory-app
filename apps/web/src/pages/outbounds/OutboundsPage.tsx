...
export function OutboundsPage() {
  ...
  const { items, pagination, loading, error, filters, setSearch, setPage, summary } = useOutbounds({
    search: '',
  });
    ...
    <div className={styles.container}>
      <header className={styles.headerRow}>
        ...
        <div className={styles.actions}>
          <button type="button" className={styles.secondaryButton} disabled={!canRegisterOutbound}>
            출고 템플릿
          </button>
          <button type="button" className={styles.primaryButton} disabled={!canRegisterOutbound}>
            출고 등록
          </button>
        </div>
      </header>
